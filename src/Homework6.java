public class Homework6 {
    public static void main(String[] args) {
        OfflineCourse course1 = new OfflineCourse("HAEA9201", "Object Oriented Programming"); // 오프라인 강좌 생성
        OnlineCourse course2 = new OnlineCourse("HAFL0012", "C Programming 1"); // 온라인 강좌 생성
